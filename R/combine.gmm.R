#' Combine shape datasets
#'
#' @source   Dave Angelini \email{david.r.angelini@@gmail.com} [aut, cre]
#'
#' @param A1 A \code{geomorph.data.frame} or a data structure produced by functions in the \code{borealis} package.
...
#'     of specimens.
#' @param A2 A second shape dataset, to be combined with \code{A1}.
#'     The two datasets must have the same number of landmarks to allow for downstream
#'     analyses.
#' @param group.names An optional character vector describing the
#'
#' @export
#'
#' @examples
...
combine.gmm <- function (A, specimens = NULL, landmarks = NULL)
{

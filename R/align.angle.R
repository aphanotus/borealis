...
#'                  art.pt = 11,       # These three variables:
#'                  angle.pts.1 = 1:10,  #   art.pt, angle.pts.1 & angle.pts.2
#'                  angle.pts.2 = 12:15,  #   define the angle to align
#'                  rot.pts = 12:16, # rot.pts defines the points to actually rotate
#'                  links = mantis.lines )
#'
